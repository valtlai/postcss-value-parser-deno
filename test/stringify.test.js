...
Deno.test("Stringify", function() {
  tests.forEach(function(opts) {
    assertStrictEquals(stringify(parse(opts.fixture)), opts.fixture, opts.message);
  });
  ...
  tokens[1].type = "word";
  assertStrictEquals(stringify(tokens), " rgba ", "Shouldn't process nodes of work type");
